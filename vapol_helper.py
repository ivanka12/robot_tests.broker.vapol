...
def convert_vapol_date_to_iso_format(date_time_from_ui):
...
def vapol_download_file(url, file_name, output_dir):
    urllib.urlretrieve(url, ('{}/{}'.format(output_dir, file_name)))

def convert_vapol_string(string):
    return {
            'True':                                                 '1',
            'False':                                                '0',
            u"Так":                                                 True,
